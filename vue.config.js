...
module.exports = {
    ...
    devServer: {
        ...
        proxy: {
            "/consumer": {
                // target: "http://47.93.22.144:8100",
                target: "http://nevt05:30214",
                changeOrigin: true,
                pathRewrite: {
                    "^/consumer": "/"
                }
            ...
            "/foton": {
                target: "https://saas.itink.com.cn/",
                changeOrigin: true,
                pathRewrite: {
                    "^/foton": ""
                }
