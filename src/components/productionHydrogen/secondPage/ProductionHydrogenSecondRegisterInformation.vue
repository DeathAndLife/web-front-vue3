<template>
    <element-border :height="400">
        <p class="p-component">制氢厂注册信息</p>
        <el-row class="margin-top-10">
            <el-col :span="10">
                <p class="p-left">制氢厂类型:</p>
            </el-col>
            <el-col :span="14">
...
<script>
import {getProductionStationRegisterInformationById} from "@/api/consumer-http";

export default {
    name: "ProductionHydrogenSecondRegisterInformation",
    data() {
        return {
            type: "___",
            code: "___",
    ...
    methods: {
        async initData() {
            try {
                let result = await getProductionStationRegisterInformationById(this.id);
