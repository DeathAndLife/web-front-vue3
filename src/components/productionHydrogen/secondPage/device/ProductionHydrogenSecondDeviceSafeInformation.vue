...
<script>
import {getSafetyContactInformationOfProductionById} from "@/api/consumer-http";

export default {
    name: "ProductionHydrogenSecondDeviceSafeInformation",
    data() {
        return {
            persons: [],
    ...
    methods: {
        async initData() {
            try {
                let result = await getSafetyContactInformationOfProductionById(this.id);
